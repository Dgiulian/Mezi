    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {           
           ...
           if ( !baja)throw new BaseException("ERROR","Ocurrio un error al eliminar el registro");
            ...
            TAuditoria.guardar(id_usuario,id_tipo_usuario,OptionsCfg.MODULO_USUARIO,OptionsCfg.ACCION_BAJA,usuario.getId(),tu.auditar(usuario));
               jr.setResult("OK");               
