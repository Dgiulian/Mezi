...
<div class="modal fade" id="mdlPropietario">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped table-condensed" id="tblPropietario">
                        <thead>
                            <tr>
                                <th>Carpeta</th>
...
<script>
    $(document).ready(function(){
       $('#mdlPropietario').on('show.bs.modal',function(){
           //loadDataCliente({});
               ...
               success: function(result) {
                   if(result.Result === "OK") {
                       ...
                       $('.btnSelCliente').click(function(){
                           ...
                           $('#propietario').val(apellido + ", " + nombre);
                           $('#mdlPropietario').modal('hide');
                       });
                   }
               }
