...
<body>
				...
				<div class="col-lg-12">
                                    <div class="box">
                                        <div class="box-header">
                                            <H3>Reporte general de cajas </H3>
                                        </div>
   ...
   function createTable(data){
        ...
        for(var i = 0;i< data.length;i++){
            ...
            //html += wrapTag('td',d.forma,'');               
            html += wrapTag('td',d.efectivo_cierre,'');
            html += wrapTag('td',d.cheque_cierre,'');
            html += wrapTag('td',d.transferencia_cierre,'');
            html +="</tr>";
