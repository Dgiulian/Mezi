 ...
 * @author Diego
 */
public class BarrioPath extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Localidad localidad = new TLocalidad().getById(id_localidad);
        if(localidad!=null) request.setAttribute("localidad",localidad);
